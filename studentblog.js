...
th: {
keyinfotitle: "ข้อมูลสำคัญ",

keyinfoquestion1: "ฉันจะลงทะเบียนเรียนได้อย่างไร",
keyinfoanswer1: "ให้เข้าสู่เว็บไซต์ลงทะเบียน (reg.cmru) และเข้าสู่ระบบโดยใช้รหัสนักศึกษา โดยใช้เลขบัตรประชาชนหรือหนังสือเดินทางเป็นรหัสผ่าน จากนั้นคลิก “Enroll” แล้วเลือกลงทะเบียนรายวิชาตามแผนการเรียนของคุณ หลังจากนั้นคลิก “Confirm Enrollment” และอย่าลืมชำระค่าธรรมเนียมการศึกษาภายในระยะเวลาที่กำหนด",

keyinfoquestion2: "อีเมล CMRU ของฉันคืออะไร",
keyinfoanswer2: "ชื่อผู้ใช้อีเมลของคุณคือรหัสนักศึกษา ตามด้วย @cmru.ac.th ส่วนรหัสผ่านคือ cmru@DD/MM/YYYY โดยอ้างอิงจากวันเดือนปีเกิดของคุณในรูปแบบปี พ.ศ.",

keyinfoquestion3: "หน่วยกิตกิจกรรมนักศึกษาคืออะไร",
keyinfoanswer3: "นักศึกษาจะต้องสะสมหน่วยกิตกิจกรรมให้ครบอย่างน้อย 118 หน่วยกิตตลอดหลักสูตร 4 ปี โดยแต่ละกิจกรรมจะได้รับประมาณ 3 หน่วยกิต และเป็นเงื่อนไขที่จำเป็นสำหรับการสำเร็จการศึกษา",

keyinfoquestion4: "ฉันจะสะสมหน่วยกิตกิจกรรมนักศึกษาได้อย่างไร",
keyinfoanswer4: "คุณสามารถสะสมหน่วยกิตได้จากการเข้าร่วมกิจกรรมต่าง ๆ เช่น โครงการปฐมนิเทศ เวิร์กชอป สัมมนา กิจกรรมชมรมหรือกิจกรรมนักศึกษา กิจกรรมจิตอาสา รวมถึงการตอบแบบประเมินหรือแบบสอบถาม",

keyinfoquestion5: "ประกันสุขภาพนักศึกษาครอบคลุมอะไรบ้าง",
keyinfoanswer5: "ความคุ้มครองประกันสำหรับปีการศึกษา 2566–2567 ครอบคลุมค่ารักษาพยาบาลสูงสุด 15,000 บาท และค่าช่วยเหลือกรณีเสียชีวิตสูงสุด 20,000 บาท",

keyinfoquestion6: "โรงพยาบาลใดบ้างที่อยู่ในเครือข่ายคู่สัญญา",
keyinfoanswer6: "โรงพยาบาลในเครือข่าย ได้แก่ โรงพยาบาลลานนา เชียงใหม่, โรงพยาบาลราชเวช เชียงใหม่, โรงพยาบาลแมคคอร์มิค, โรงพยาบาลเชียงใหม่, โรงพยาบาลมหาราชนครเชียงใหม่ และโรงพยาบาลเทพปัญญา",

keyinfoquestion7: "ฉันจะใช้สิทธิ์ประกันนักศึกษาได้อย่างไร",
keyinfoanswer7: "ในเวลาราชการ คุณต้องแสดงบัตรประจำตัวประชาชนและบัตรประกันอุบัติเหตุ ส่วนนอกเวลาราชการก็ต้องแสดงบัตรประจำตัวประชาชนและบัตรประกันอุบัติเหตุเช่นกัน โดยสามารถติดต่อกองพัฒนานักศึกษาได้ที่หมายเลข 053-885430 ในวันและเวลาราชการของมหาวิทยาลัย",


generallinkstitle: "ลิงก์สำคัญที่นักศึกษาทุกคนควรตรวจสอบ",
generallinksdesc1: "เว็บไซต์หลักของมหาวิทยาลัย สำหรับติดตามข่าวสาร คณะต่าง ๆ บริการ และข้อมูลการลงทะเบียน",
generallinksdesc2: "ใช้สำหรับลงทะเบียนเรียน ตรวจสอบตารางเรียน และจัดการข้อมูลทางวิชาการ",
generallinksdesc3: "เพจ Facebook อย่างเป็นทางการของสำนักทะเบียนและประมวลผล",
generallinksdesc4: "ข้อมูลสำหรับนักศึกษาใหม่",
generallinksdesc5: "รวมข้อมูลคณะ วิทยาลัย และหน่วยงานทางวิชาการทั้งหมด",
generallinksdesc6: "ข้อมูลเกี่ยวกับทุนการศึกษา สุขภาพนักศึกษา กิจกรรมนักศึกษา การแนะแนวอาชีพ ประกันภัย สุขภาพจิต และกิจกรรมต่าง ๆ",
generallinksdesc7: "ข้อมูลเกี่ยวกับหอพักนักศึกษา รวมถึงสิ่งอำนวยความสะดวก ค่าใช้จ่าย และช่องทางติดต่อ",
generallinksdesc8: "คอร์สเรียนออนไลน์ เช่น ธุรกิจ ภาษาไทย ทักษะดิจิทัล และ AI พร้อมใบประกาศนียบัตร",


wiangbuatitle: "ลิงก์สำคัญสำหรับนักศึกษาวิทยาเขตเวียงบัว",
wiangbuadesc1: "ข้อมูลสำหรับนักศึกษา อาจารย์ และผู้ปกครอง",
wiangbuadesc2: "ใช้สำหรับลงทะเบียนเรียน ตรวจสอบตารางเรียน และจัดการข้อมูลทางวิชาการ",
wiangbuadesc3: "เพจ Facebook อย่างเป็นทางการของสำนักทะเบียนและประมวลผล",
wiangbuadesc4: "เว็บไซต์อย่างเป็นทางการของนักศึกษา IC-CMRU",
wiangbuadesc5: "เพจ Facebook อย่างเป็นทางการของวิทยาลัยนานาชาติ",
wiangbuadesc6: "บริการสำหรับนักศึกษา IC-CMRU เช่น การลงทะเบียน เอกสาร การชำระค่าเล่าเรียน และการฝึกงาน",
wiangbuadesc7: "ข้อมูลโครงการฝึกงาน รายชื่อบริษัท และการจัดสรรสถานที่ฝึกงาน (เหมาะสำหรับนักศึกษาชั้นปีที่ 4)",
wiangbuadesc8: "บริการห้องสมุดและทรัพยากรทางวิชาการ",
wiangbuadesc9: "เพจ Facebook อย่างเป็นทางการของห้องสมุด CMRU",
wiangbuadesc10: "ระบบบริการดิจิทัล เช่น แพลตฟอร์มออนไลน์ ระบบ e-learning และการสนับสนุนด้าน IT",
wiangbuadesc11: "เพจ Facebook อย่างเป็นทางการของ Digital CMRU",
wiangbuadesc12: "เพจ Facebook อย่างเป็นทางการของ CMRU Shop สำหรับสินค้าและของที่ระลึก",
wiangbuadesc13: "เว็บไซต์สำหรับนักศึกษาระดับบัณฑิตศึกษา",
wiangbuadesc14: "เพจ Facebook อย่างเป็นทางการของบัณฑิตวิทยาลัย",
wiangbuadesc15: "ข้อมูลสำหรับผู้ปกครองของนักเรียนโรงเรียนสาธิต",
wiangbuadesc16: "เพจ Facebook อย่างเป็นทางการของโรงเรียนสาธิต",
wiangbuadesc17: "เว็บไซต์ของคณะมนุษยศาสตร์และสังคมศาสตร์",
wiangbuadesc18: "เพจ Facebook อย่างเป็นทางการของคณะมนุษยศาสตร์และสังคมศาสตร์",


othercampusestitle: "สำหรับนักศึกษาในวิทยาเขตอื่น ๆ",
othercampusesdesc1: "ข้อมูลเกี่ยวกับคณะวิทยาศาสตร์และเทคโนโลยี (สาขาคณิตศาสตร์และวิทยาศาสตร์)",
othercampusesdesc2: "เพจ Facebook อย่างเป็นทางการของคณะคณิตศาสตร์และวิทยาศาสตร์",
othercampusesdesc3: "เว็บไซต์สำหรับนักศึกษาที่สนใจโครงการด้านชุมชนและพลังงานหมุนเวียน",
othercampusesdesc4: "เพจ Facebook อย่างเป็นทางการของ ADICET",
othercampusesdesc5: "เว็บไซต์ของคณะวิทยาศาสตร์และเทคโนโลยี",
othercampusesdesc6: "เพจ Facebook อย่างเป็นทางการของคณะวิทยาศาสตร์และเทคโนโลยี",
othercampusesdesc7: "เว็บไซต์ของคณะเทคโนโลยีการเกษตร",
othercampusesdesc8: "เพจ Facebook อย่างเป็นทางการของคณะเทคโนโลยีการเกษตร",

buildings: "อาคารต่าง ๆ",
map: "แผนที่วิทยาเขตเวียงบัว",
"map indicators list": "สัญลักษณ์บนแผนที่",

indicator1: "อาคารสำนักงานอธิการบดี / กองคลัง / สำนักงานทะเบียนและประมวลผล",
indicator2: "ภาควิชาวิทยาการคอมพิวเตอร์",
indicator3: "ภาควิชาวิทยาศาสตร์สิ่งแวดล้อม",
indicator4: "ภาควิชาเคมี",
indicator5: "ภาควิชาคณิตศาสตร์",
indicator6: "กองพัฒนานักศึกษา",
indicator7: "คณะมนุษยศาสตร์และสังคมศาสตร์",
indicator8: "ศูนย์ประสานงานคณะเทคโนโลยีการเกษตร",
indicator9: "สำนักงานการศึกษาดิจิทัล",
indicator10: "อาคารคหกรรมศาสตร์",
indicator11: "โรงยิม (Gymnasium)",
indicator12: "ภาควิชาเทคโนโลยีอุตสาหกรรม",
indicator13: "อาคารดนตรี",
indicator14: "อาคารนาฏศิลป์ (ศิลปะการแสดง/การเต้น)",
indicator15: "อาคารศิลปกรรม",
indicator16: "ภาควิชาชีววิทยา",
indicator17: "ภาควิชาฟิสิกส์",
indicator18: "ภาควิชาสาธารณสุข",
indicator19: "อาคารสมเด็จพระเจ้าลูกเธอ เจ้าฟ้าจุฬาภรณวลัยลักษณ์",
indicator20: "คณะวิทยาการจัดการ",
indicator21: "อาคารเรียนศิลปกรรม",
indicator22: "อาคารโรงเรียนสาธิตมหาวิทยาลัยราชภัฏเชียงใหม่",
indicator23: "อาคารศูนย์การศึกษาพิเศษ",
indicator24: "หอพักนักศึกษาต่างชาติ",
indicator25: "สหภาพนักศึกษา",
indicator26: "สำนักงานห้องสมุด",
indicator27: "อาคารที่ระลึกราชภัฏ",
indicator28: "คณะวิทยาศาสตร์และเทคโนโลยี",
indicator29: "อาคารราชภัฏ 90 ปี",


"buildings section": "อาคารต่าง ๆ",

"library link": "ห้องสมุด",
"digital cmru link": "ดิจิทัล CMRU",
"central division link": "สำนักงานกองกลาง",
"student division link": "กองพัฒนานักศึกษา",
"memorial building link": "อาคาร 27 / อาคารอนุสรณ์",
"infirmary link": "โรงพยาบาลมหาวิทยาลัย",
"cmru shop link": "ร้าน CMRU",
"more buildings": "จะมีอาคารเพิ่มเติมในอนาคต"
